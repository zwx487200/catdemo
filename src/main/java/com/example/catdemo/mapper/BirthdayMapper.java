...
public interface BirthdayMapper extends BaseMapper<Birthday> {
     ...
     * @return 列表
     */
    List<Birthday> selectByExampleWithBLOBs(BirthdayExample example);
     ...
     * @return 记录信息
     */
    Birthday selectByPrimaryKey(String id);
     ...
     * @return 更新数量
     */
    int updateByExampleWithBLOBs(@Param("record") Birthday record, @Param("example") BirthdayExample example);
     ...
     * @return 更新数量
     */
    int updateByPrimaryKeyWithBLOBs(Birthday record);
